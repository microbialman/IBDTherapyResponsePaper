...
repdat=read.table(here("Data","Input","Arijs_2009_cleaned_expr_dat.tsv"),sep="\t")
...
metadat=read.table(here("Data","Input","Arijs_2009_cleaned_meta_table.tsv"),sep="\t")
...
#write out the pretreatment MEs for the AUC analysis
write.csv(RepMEs[which(metadat$PostTreatment==0),],here("Data","Generated","Arijs_2009_pre_treat_MEs.csv"))
```
