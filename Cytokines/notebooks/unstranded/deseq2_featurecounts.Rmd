...
for(contrast in names(contrasts))
{
 ...
 samples <- sample_info$sample_id[sample_info$experiment_group %in%   contrasts[[contrast]][2:3]]
...
kable(summary,caption=paste("Numbers of differentially expressed genes (padj<0.05, fold change > ",
                            abs_fc_threshold,")"))
