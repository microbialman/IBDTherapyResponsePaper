...
```{r exp-cor, fig.cap='Inter-sample correlation heatmap.', fig.height=6, fig.width=6,  echo=FALSE, message=FALSE, eval=TRUE}
...
```{r exp-dist, fig.cap='Inter-sample distance heatmap.', fig.height=6, fig.width=6,  echo=FALSE, message=FALSE, eval=TRUE}
...
require(Rtsne)
tsne_out = Rtsne(t(filteredVSTMat), pca=T, perplexity=3)
```
